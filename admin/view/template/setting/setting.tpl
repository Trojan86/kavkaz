        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-email-boss"><?php echo $entry_email; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_email_boss" value="<?php echo $config_email_boss; ?>" placeholder="<?php echo $entry_email; ?>" id="input-email-boss" class="form-control" />
                  <?php if ($error_email) { ?>
                  <div class="text-danger"><?php echo $error_email; ?></div>
                  <?php } ?>
                </div>
