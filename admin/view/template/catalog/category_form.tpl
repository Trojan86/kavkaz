          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10"><a href="" id="thumb-icon" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_icon; ?>" alt="" title="" data-placeholder="<?php echo $placeholder_icon; ?>" /></a>
                  <input type="hidden" name="icon" value="<?php echo $icon; ?>" id="input-icon" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_icon_mob; ?></label>
                <div class="col-sm-10"><a href="" id="thumb-icon_mob" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_icon_mob; ?>" alt="" title="" data-placeholder="<?php echo $placeholder_icon_mob; ?>" /></a>
                  <input type="hidden" name="icon_mob" value="<?php echo $icon_mob; ?>" id="input-icon_mob" />
                </div>
              </div>
              <div class="form-group">
