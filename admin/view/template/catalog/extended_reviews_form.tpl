          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <?php } ?>
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-container"><?php echo $text_purchased; ?></label>
                    <div class="col-sm-10">
                      <div class="radio-group-lite">
                            <input id="allready_buy_off" class="hide-radio radio-off" type="radio" name="purchased" value="0" <?php echo !empty($purchased) && $purchased ? '' : 'checked'; ?>>
                            <label for="allready_buy_off"><?php echo $text_yes; ?></label>
                            <input id="allready_buy_on" class="hide-radio radio-on" type="radio" name="purchased" value="1" <?php echo !empty($purchased) && $purchased ? 'checked' : ''; ?>>
                            <label for="allready_buy_on"><?php echo $text_no; ?><span class="onoffswitch-inner"></span><span class="onoffswitch-switch"></span></label>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
