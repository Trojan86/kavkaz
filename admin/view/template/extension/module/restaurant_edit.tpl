    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i><?php echo $text_edit_contacts; ?></h3>
            </div>
            <div class="panel-body">
                <p style="color: red"><?php echo $text_mustfill; ?></p>
                <form action="<?php echo $action; ?>" method="post" name="edit" id="<?php echo $edit_id?>" class="form-horizontal restaurant_edit">

                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="phone"><?php echo $text_phone_nmb?><span class="required">*</span></label>
                        <div class="col-sm-10">
                            <input id="phone" type="text" name="phone" class="form-control" value="<?php echo $contact['phone']?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="work_start"><?php echo $text_work_start?><span class="required">*</span></label>
                        <div class="col-sm-10">
                            <input id="work_start" type="text" name="work_start" class="form-control" value="<?php echo $contact['work_start']?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="work_finish"><?php echo $text_work_finish?><span class="required">*</span></label>
                        <div class="col-sm-10">
                            <input id="work_finish" type="text" name="work_finish" class="form-control" value="<?php echo $contact['work_finish']?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="street"><?php echo $text_street?><span class="required">*</span></label>
                        <div class="col-sm-10">
                            <input required id="street" type="text" name="street" class="form-control" value="<?php echo $contact['street']?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input id="building" type="text" name="building" class="form-control" value="<?php echo $contact['building']?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input id="place" type="text" name="place" class="form-control" value="<?php echo $contact['place']?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input id="iframe" type="text" name="iframe" class="form-control" value='<?php echo $contact["iframe"]?>'/>
                        </div>
                        <p><?php echo $text_map_description; ?></p>
                    </div>

                    <div class="form-group" style="display: none">
                        <label class="col-sm-2 control-label" for="edit_id"><?php echo $text_enter_place; ?><span class="required">*</span></label>
                        <div class="col-sm-10">
                            <input id="edit_id" type="text" name="edit_id" class="form-control" value="<?php echo $contact['contact_id']?>"/>
                        </div>
                    </div>
                    <div class="footer_admin">

                        <input type="Submit"  name="edit" value="<?php echo $text_submit_edit; ?>" class="admin_button_add">
