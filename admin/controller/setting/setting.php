...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['config_email_boss'])) {
            $data['config_email_boss'] = $this->request->post['config_email_boss'];
        } else {
            $data['config_email_boss'] = $this->config->get('config_email_boss');
        }
	...
	protected function validate() {
        ...
        if ((utf8_strlen($this->request->post['config_email_boss']) > 96) || !filter_var($this->request->post['config_email_boss'], FILTER_VALIDATE_EMAIL)) {
            $this->error['email'] = $this->language->get('error_email');
        }
