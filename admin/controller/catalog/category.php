...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
        ...
        $data['entry_icon_mob'] = $this->language->get('entry_icon_mob');
        ...
        if (isset($this->request->post['icon_mob'])) {
            $data['icon_mob'] = $this->request->post['icon_mob'];
        } elseif (!empty($category_info)) {
            $data['icon_mob'] = $category_info['icon_mob'];
        } else {
            $data['icon_mob'] = '';
        }
        ...
        if (isset($this->request->post['icon']) && is_file(DIR_IMAGE . $this->request->post['icon'])) {
            ...
            $data['thumb_icon'] = $this->model_tool_icon->resize($category_info['icon'], 100, 100);
        } else {
            $data['thumb_icon'] = $this->model_tool_icon->resize('no_image.png', 100, 100);
        }

        if (isset($this->request->post['icon_mob']) && is_file(DIR_IMAGE . $this->request->post['icon_mob'])) {
            $data['thumb_icon_mob'] = $this->model_tool_icon->resize($this->request->post['icon_mob'], 100, 100);
        } elseif (!empty($category_info) && is_file(DIR_IMAGE . $category_info['icon'])) {
            $data['thumb_icon_mob'] = $this->model_tool_icon->resize($category_info['icon_mob'], 100, 100);
        } else {
            $data['thumb_icon_mob'] = $this->model_tool_icon->resize('no_image.png', 100, 100);
        }

		$data['placeholder'] = $this->model_tool_image->resize('no_image.png', 100, 100);
        $data['placeholder_icon'] = $this->model_tool_image->resize('no_image.png', 100, 100);
        $data['placeholder_icon_mob'] = $this->model_tool_image->resize('no_image.png', 100, 100);
