    ...
    <div class="<?php echo $page == 'checkout' ? 'col-sm-8' : 'col-sm-10' ?>">
      ...
      <?php } elseif ($type == 'radio') { ?>
        ...
        <?php foreach ($values as $info_id => $info) { ?>
          <div class="radio">
            <input class="custom-radio radio-field" type="radio" name="<?php echo $name ?>" id="<?php echo $id ?>_<?php echo $info_id ?>" value="<?php echo $info['id'] ?>" <?php echo $value == $info['id'] ? 'checked="checked"' : '' ?> <?php echo $reload ? 'data-onchange="reloadAll"' : ''?>>
            <label class="label__delivery-1" for="<?php echo $id ?>_<?php echo $info_id ?>"><span><?php echo $info['text'] ?></span></label>
          </div>
        <?php } ?>
        </div>
      ...
      <img id="image" class="private__data-image" src="catalog/view/theme/default/img/avatar-1.png" alt="avatar image">
      <input id="imgInput" type="button" value="<?php echo $button_upload; ?>" data-file="<?php echo $id ?>" class="button form-control">
      ...
      <?php } elseif ($type == 'date') { ?>
        <div class="input-group date">
          ...
          <span class="input-group-btn">
            <button type="button" class="btn btn-default"><img src="catalog/view/theme/default/img/data.png" alt="data icon"></button>
          </span>
        </div>
