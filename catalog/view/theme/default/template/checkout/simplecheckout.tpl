    ...
    <div class="simplecheckout">
        ...
        <div class="simplecheckout-steps-wrapper">
            ...
            '{left_column}'      => '<div class="simplecheckout-left-column">
                <div class="block_warning desktop">' . $block_warning_desk_simp . '</div>',
                '{/left_column}'     => '</div>',
            '{right_column}'     => '<div class="simplecheckout-right-column">',
                '{/right_column}'    => '<a class="button btn-primary button_oc btn" data-onclick="createOrder" id="simplecheckout_button_confirm"><span>'.$button_order.'</span></a></div>',
            '{step}'             => '<div class="simplecheckout-step">
                ',
                '{/step}'            => '<div class="block_warning_mob mobile">' . $block_warning_mob_simp . '</div></div>',
...
<!--<div class="input-data-box input-time-box">
    <i class="icon-time"></i>
    <input autocomplete="off" placeholder="Время" type="text" readonly="readonly">
</div> -->
<div>
</div>
<script>
    $(document).ready(function(){
        $("#buttons").on("click","a",  function (event) {
            ...
            var top = $("#simplecheckout_customer").offset().top;
