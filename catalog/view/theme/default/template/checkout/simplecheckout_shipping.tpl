            ...
            <?php } else { ?>
                ...
                <?php foreach ($shipping_methods as $shipping_method) { ?>
                    ...
                    <?php if (empty($shipping_method['error'])) { ?>
                        <?php foreach ($shipping_method['quote'] as $quote) { ?>
                            <div class="radio">
                                <input class="custom-radio radio-field" type="radio" data-onchange="reloadAll" name="shipping_method" <?php echo !empty($quote['dummy']) ? 'disabled="disabled"' : '' ?> <?php echo !empty($quote['dummy']) ? 'data-dummy="true"' : '' ?> value="<?php echo $quote['code']; ?>" id="<?php echo $quote['code']; ?>" <?php if ($quote['code'] == $code) { ?>checked="checked"<?php } ?> />
                                <label class="label__delivery-1" for="<?php echo $quote['code']; ?>"><span><?php echo !empty($quote['title']) ? $quote['title'] : ''; ?></span></label>
                            </div>
