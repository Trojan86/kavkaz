...
class ControllerCheckoutSimpleCheckout extends SimpleController {
    ...
    public function index($args = null) {
        ...
        $this->_templateData['block_warning_desk_simp']             = $this->language->get('block_warning_desk_simp');
        $this->_templateData['block_warning_mob_simp']             = $this->language->get('block_warning_mob_simp');
